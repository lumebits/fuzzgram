        ...
        return GridView.count(
          ...
          children: [
            CategoryItem(category: new Category(
                "movies", "assets/categories/movies.jpg")),
            CategoryItem(category: new Category(
                "beauty", "assets/categories/beauty.jpg", 0.3)),
            CategoryItem(category: new Category(
                "tv shows", "assets/categories/tv-shows.jpg")),
            CategoryItem(category: new Category(
                "travel", "assets/categories/travel.jpg", 0.2)),
            CategoryItem(category: new Category(
                "animals", "assets/categories/animals.jpg", 0.2)),
            CategoryItem(category: new Category(
                "tech", "assets/categories/tech.jpg", 0.15)),
            CategoryItem(category: new Category(
                "food", "assets/categories/food.jpg", 0.2)),
            CategoryItem(category: new Category(
                "fashion", "assets/categories/fashion.jpg", 0.2)),
            CategoryItem(category: new Category(
                "productivity", "assets/categories/productivity.jpg", 0.2)),
            CategoryItem(category: new Category(
                "sport", "assets/categories/sport.jpg", 0.15)),
            CategoryItem(category: new Category(
                "music", "assets/categories/music.jpg", 0.15)),
            CategoryItem(category: new Category(
                "self care", "assets/categories/self-care.jpg")),
            CategoryItem(category: new Category(
            ...
            child: Ink(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  context.read<ExploreBloc>().add(CategoryTapped(category.name));
                },
                child: Center(
                  child: Text(
